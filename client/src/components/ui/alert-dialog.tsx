...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted mb-2 mr-2 inline-flex w-11 h-11 items-center justify-center rounded-md sm:group-data-[size=default]/alert-dialog-content:row-span-2 *:[svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
